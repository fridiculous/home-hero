...
# as a server
docker run -p 8000:8000 -it --rm -v $(pwd)/hero:/code -v $(pwd)/data:/data api python3 manage.py migrate

docker run -p 8000:8000 -it --rm -v $(pwd)/hero:/code -v $(pwd)/data:/data  api python3 manage.py runserver 0.0.0.0:8000

# shell
docker run -it --rm -v $(pwd)/hero:/code -v $(pwd)/data:/data api python3 manage.py shell
```
